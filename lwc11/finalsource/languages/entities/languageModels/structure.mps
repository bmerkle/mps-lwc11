...
<model modelUID="r:fbcd9867-33ac-4cca-b510-29a3a4ed591f(entities.structure)" version="0">
  ...
  <roots>
    ...
    <node type="tpce.InterfaceConceptDeclaration" typeId="tpce.1169125989551" id="7853931227643491202">
      <property name="name" nameId="tpck.1169194664001" value="IResourceContent" />
      <property name="virtualPackage" nameId="tpck.1193676396447" value="resources" />
    </node>
    <node type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2900074371115301236">
      <property name="name" nameId="tpck.1169194664001" value="EARefExpr" />
      <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpee.1068431790191" resolveInfo="Expression" />
    </node>
    <node type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2900074371115346272">
      <property name="name" nameId="tpck.1169194664001" value="ResourceImport" />
      <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
    </node>
  </roots>
  <root id="7853931227643322914">
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="7853931227643329494">
      ...
      <link role="target" roleId="tpce.1071599976176" targetNodeId="7853931227643491202" resolveInfo="IResourceContent" />
    </node>
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="2900074371115330578">
  ...
  <root id="7853931227643329492">
    ...
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="7853931227643491204">
      <link role="intfc" roleId="tpce.1169127628841" targetNodeId="7853931227643491202" resolveInfo="IResourceContent" />
    </node>
  </root>
  <root id="7853931227643443459">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="2900074371115283855">
      <property name="metaClass" nameId="tpce.1071599937831" value="aggregation" />
      <property name="role" nameId="tpce.1071599776563" value="derivationExpression" />
  ...
  <root id="7853931227643491202">
    <node role="extends" roleId="tpce.1169127546356" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="7853931227643491203">
      <link role="intfc" roleId="tpce.1169127628841" targetNodeId="tpck.1169194658468" resolveInfo="INamedConcept" />
    </node>
  </root>
  <root id="2900074371115301236">
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="2900074371115301237">
      <property name="metaClass" nameId="tpce.1071599937831" value="reference" />
  ...
  <root id="2900074371115346272">
    <node role="conceptProperty" roleId="tpce.1105725339613" type="tpce.StringConceptProperty" typeId="tpce.1105725638761" id="2900074371115350886">
      <property name="value" nameId="tpce.1105725733873" value="import" />
      <link role="conceptPropertyDeclaration" roleId="tpce.1105725439818" targetNodeId="tpck.1137473891462" resolveInfo="alias" />
    </node>
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="2900074371115346273">
      <link role="intfc" roleId="tpce.1169127628841" targetNodeId="7853931227643491202" resolveInfo="IResourceContent" />
    </node>
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="2900074371115346274">
      <property name="metaClass" nameId="tpce.1071599937831" value="reference" />
      <property name="role" nameId="tpce.1071599776563" value="resource" />
      <property name="sourceCardinality" nameId="tpce.1071599893252" value="1" />
      <link role="target" roleId="tpce.1071599976176" targetNodeId="7853931227643322914" resolveInfo="EntityResource" />
    </node>
  </root>
</model>
