  ...
  <node type="entities.structure.EntityResource:0" id="7853931227643443171">
    <node role="contents:0" type="entities.structure.Entity:0" id="7853931227643443172">
      ...
      <node role="attributes:0" type="entities.structure.EntityAttribute:0" id="2900074371115301232">
        ...
        <node role="type:0" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="2900074371115310304" />
        <node role="derivationExpression:0" type="jetbrains.mps.baseLanguage.structure.TernaryOperatorExpression:3" id="2900074371115304141">
          <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="2900074371115304150">
            <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="2900074371115304153">
              <property name="value:3" value="male" />
            </node>
            <node role="leftExpression:3" type="entities.structure.EARefExpr:0" id="2900074371115304145">
              <link role="attribute:0" targetNodeId="7853931227643477952" resolveInfo="gender" />
            </node>
          </node>
          <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="2900074371115304155">
            <node role="rightExpression:3" type="entities.structure.EARefExpr:0" id="2900074371115304158">
              <link role="attribute:0" targetNodeId="7853931227643473131" resolveInfo="name" />
            </node>
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="2900074371115304154">
              <property name="value:3" value="Hello Mr. " />
            </node>
          </node>
          <node role="ifFalse:3" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="2900074371115304160">
            <node role="rightExpression:3" type="entities.structure.EARefExpr:0" id="2900074371115304163">
              <link role="attribute:0" targetNodeId="7853931227643473131" resolveInfo="name" />
            </node>
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="2900074371115304159">
  ...
  <node type="entities.structure.EntityResource:0" id="7853931227643494771">
    <node role="contents:0" type="entities.structure.Entity:0" id="7853931227643494772">
      ...
      <node role="attributes:0" type="entities.structure.EntityAttribute:0" id="7853931227643494776">
        ...
        <node role="type:0" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="2900074371115283848" />
        <node role="derivationExpression:0" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="2988397862489075303">
          <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="2988397862489075306">
            <property name="value:3" value="Hallo" />
          </node>
          <node role="leftExpression:3" type="entities.structure.EARefExpr:0" id="2988397862489075302">
    ...
    <node role="contents:0" type="instances.structure.EntityInstance:0" id="7853931227643500690">
      ...
      <node role="values:0" type="instances.structure.EntityAttributeValue:0" id="7853931227643500850">
        <link role="attribute:0" targetNodeId="7853931227643494773" resolveInfo="name" />
        <node role="expr:0" type="jetbrains.mps.baseLanguage.structure.MulExpression:3" id="2988397862489065093">
          <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.IntegerConstant:3" id="2988397862489065094">
            <property name="value:3" value="100" />
          </node>
          <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.IntegerConstant:3" id="2988397862489065095">
      ...
      <node role="values:0" type="instances.structure.EntityAttributeValue:0" id="7853931227643502765">
        ...
        <node role="expr:0" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="2988397862489065096">
          <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="2988397862489065099">
            <property name="value:3" value="Voelter" />
          </node>
          <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="2900074371115283850">
