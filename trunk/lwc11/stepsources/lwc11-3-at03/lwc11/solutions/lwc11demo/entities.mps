...
<model modelUID="r:d333185e-462b-47c5-8e7b-cee23c980bd3(entities)">
  ...
  <node type="entities.structure.EntityResource" id="7853931227643443171">
    <node role="entities" type="entities.structure.Entity" id="7853931227643443172">
      ...
      <node role="attributes" type="entities.structure.EntityAttribute" id="7853931227643487594">
        <property name="name" value="age" />
        <node role="type" type="entities.structure.StringType" id="7853931227643487595" />
      </node>
      <node role="attributes" type="entities.structure.EntityAttribute" id="7853931227643475363">
        ...
        <node role="type" type="entities.structure.EntityType" id="7853931227643475368">
          <link role="entity" targetNodeId="7853931227643475365" resolveInfo="Car" />
        </node>
      </node>
    </node>
    <node role="entities" type="entities.structure.Entity" id="7853931227643475365">
      <property name="name" value="Car" />
      <node role="attributes" type="entities.structure.EntityAttribute" id="7853931227643475366">
        <property name="name" value="make" />
        <node role="type" type="entities.structure.StringType" id="7853931227643475367" />
      </node>
    </node>
  </node>
</model>
