...
<model modelUID="r:dc1fe16e-2b01-42f7-836a-96a9c7737bc7(entities.typesystem)">
      ...
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="2900074371115313360">
        <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="2900074371115313361">
          <node role="statement:3" type="jetbrains.mps.lang.typesystem.structure.CreateEquationStatement:3" id="2900074371115314285">
            ...
            <node role="errorString:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="8630018320736861187">
              <property name="value:3" value="declared type and expression type not compatible" />
            </node>
            <node role="helginsIntention:3" type="jetbrains.mps.lang.typesystem.structure.TypesystemIntention:3" id="8630018320736986684">
              <link role="quickFix:3" targetNodeId="8630018320736945243" resolveInfo="changeAttributeType" />
              <node role="actualArgument:3" type="jetbrains.mps.lang.typesystem.structure.TypesystemIntentionArgument:3" id="8630018320736986691">
                <link role="quickFixArgument:3" targetNodeId="8630018320736962776" resolveInfo="attr" />
                <node role="value:3" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference:3" id="8630018320736987380">
                  <link role="applicableNode:3" targetNodeId="2900074371115311088" resolveInfo="attr" />
                </node>
              </node>
            </node>
  ...
  <node type="jetbrains.mps.lang.typesystem.structure.TypesystemQuickFix:3" id="8630018320736945243">
    <property name="name:3" value="changeAttributeType" />
    <node role="quickFixArgument:3" type="jetbrains.mps.lang.typesystem.structure.QuickFixArgument:3" id="8630018320736962776">
      <property name="name:3" value="attribute" />
      <node role="argumentType:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="8630018320736962778">
        <link role="concept:16" targetNodeId="1.7853931227643443459:0" resolveInfo="EntityAttribute" />
      </node>
    </node>
    <node role="executeBlock:3" type="jetbrains.mps.lang.typesystem.structure.QuickFixExecuteBlock:3" id="8630018320736945244">
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="8630018320736945245">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="8630018320736962779">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="8630018320736984117">
            <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8630018320736962781">
              <node role="operand:3" type="jetbrains.mps.lang.typesystem.structure.QuickFixArgumentReference:3" id="8630018320736962780">
                <link role="quickFixArgument:3" targetNodeId="8630018320736962776" resolveInfo="attr" />
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="8630018320736984116">
                <link role="link:16" targetNodeId="1.7853931227643443463:0" />
              </node>
            </node>
            <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8630018320736985497">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8630018320736984126">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8630018320736984121">
                  <node role="operand:3" type="jetbrains.mps.lang.typesystem.structure.QuickFixArgumentReference:3" id="8630018320736984120">
                    <link role="quickFixArgument:3" targetNodeId="8630018320736962776" resolveInfo="attr" />
                  </node>
                  <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="8630018320736984125">
                    <link role="link:16" targetNodeId="1.2900074371115283855:0" />
                  </node>
                </node>
                <node role="operation:3" type="jetbrains.mps.lang.typesystem.structure.Node_TypeOperation:3" id="8630018320736985496" />
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_CopyOperation:16" id="8630018320736985501" />
            </node>
          </node>
        </node>
      </node>
    </node>
    <node role="descriptionBlock:3" type="jetbrains.mps.lang.typesystem.structure.QuickFixDescriptionBlock:3" id="8630018320736986687">
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="8630018320736986688">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="8630018320736986689">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="8630018320736986690">
            <property name="value:3" value="fix type" />
          </node>
        </node>
      </node>
    </node>
