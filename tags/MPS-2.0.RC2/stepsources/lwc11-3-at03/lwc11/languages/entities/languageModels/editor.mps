...
<model modelUID="r:ea982407-62db-405b-874a-a6a6c5038480(entities.editor)">
  ...
  <roots>
    ...
    <node type="tpc2.ConceptEditorDeclaration" typeId="tpc2.1071666914219" id="9064351649708309180">
      <property name="virtualPackage" nameId="tpck.1193676396447" value="types" />
      <link role="conceptDeclaration" roleId="tpc2.1166049300910" targetNodeId="jv2p.9064351649708309178" resolveInfo="BoolType" />
    </node>
  </roots>
            ...
            <node role="statement" roleId="tpee.1068581517665" type="tpee.LocalVariableDeclarationStatement" typeId="tpee.1068581242864" id="7853931227643477960">
              <node role="localVariableDeclaration" roleId="tpee.1068581242865" type="tpee.LocalVariableDeclaration" typeId="tpee.1068581242863" id="7853931227643477961">
                ...
                <node role="initializer" roleId="tpee.1068431790190" type="tpee.GenericNewExpression" typeId="tpee.1145552977093" id="7853931227643477964">
                  <node role="creator" roleId="tpee.1145553007750" type="tpdg.SNodeCreatorAndInitializer" typeId="tpdg.5979988948250981289" id="1280757645435940011">
                    <node role="createdType" roleId="tp25.1180636770616" type="tp25.SNodeType" typeId="tp25.1138055754698" id="1280757645435940012">
                      <link role="concept" roleId="tp25.1138405853777" targetNodeId="jv2p.7853931227643443459" resolveInfo="EntityAttribute" />
                    </node>
                  </node>
                </node>
  ...
  <root id="9064351649708309180">
    <node role="cellModel" roleId="tpc2.1080736633877" type="tpc2.CellModel_Constant" typeId="tpc2.1073389577006" id="9064351649708309182">
